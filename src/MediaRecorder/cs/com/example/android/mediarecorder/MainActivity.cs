...
using Java.Lang;
using Android.Util;
using com.example.android.common.media;
using XAMediaRecorder;
using System.Collections.Generic;

namespace com.example.android.mediarecorder
{
    [Activity(Label = "MediaRecorder", MainLauncher = true, ScreenOrientation = ScreenOrientation.Landscape)]
    public class MainActivity : Activity
    {
        ...
        protected override void OnCreate(Bundle savedInstanceState)
        {
            ...
            SetContentView(Resource.Layout.SampleMain);
